    ...
    return (
        ...
        >
            ...
            {anime.bannerImage && (
                <>
                    <div
                        className="absolute inset-0 z-0 opacity-20 grayscale bg-cover bg-center transition-all duration-300 group-hover:grayscale-0 group-hover:opacity-40"
            ...
            <div className="pl-5 py-2 pr-2 flex flex-row flex-1 relative z-10 overflow-hidden gap-4">
                {/* Left 70% */}
                <div className="flex flex-col w-[70%] pr-4 border-r border-white/5">
                        ...
                        <div className="flex flex-col items-start justify-center gap-2 flex-shrink-0 bg-[#151f2e]/50 backdrop-blur-xs px-3 py-2 rounded min-w-[85px]">
                            {anime.averageScore && (
                                <div className="text-[#9fadbd] text-sm font-bold flex items-center gap-2">
                                    <SVG name="star" size="" className="w-4 h-4 flex-shrink-0 -ml-[1.5px]" style={{ color: anime.coverImage?.color || '#60a5fa' }} />
                    ...
                    <div
                        className="mt-3 mb-2 text-[13px] text-[#8ba0b2] leading-relaxed overflow-y-auto custom-scrollbar-hidden flex-1"
                ...
                {/* Right 30% */}
                <div className="flex flex-col w-[30%] h-full items-start min-w-0">
